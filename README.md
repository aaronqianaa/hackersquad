...
- `PUT /projects/{id}/campaigns/{campaign_id}/artifacts/{artifact_id}`
- `GET /projects/{id}/campaigns/{campaign_id}/artifacts/{artifact_id}/revisions`
- `POST /projects/{id}/campaigns/{campaign_id}/artifacts/{artifact_id}/restore`
- `POST /memory/purge`
